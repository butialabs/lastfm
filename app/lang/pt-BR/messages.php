...
return [
    ...
    'admin.artists.find_providers' => 'Buscar nos Provedores',
    'admin.artists.loading_sources' => 'Carregando imagens dos provedores...',
    'admin.artists.no_sources' => 'Nenhuma imagem encontrada nos provedores',
    'admin.artists.bulk_find_images' => 'Buscar Imagens',
    'admin.artists.wizard_fetching' => 'Buscando fontes %d de %d...',
    'admin.artists.wizard_no_sources' => 'Nenhuma imagem encontrada em nenhum provedor',
    'admin.artists.wizard_review' => 'Revisão %d de %d',
    'admin.artists.wizard_skip' => 'Pular',
    'admin.artists.wizard_close' => 'Fechar',
    'admin.artists.wizard_summary' => 'Resumo',
    'admin.artists.wizard_downloaded' => 'Baixadas',
    'admin.artists.wizard_skipped' => 'Puladas',
    'admin.artists.wizard_no_results' => 'Nenhuma imagem foi baixada',
    ...
    'admin.config.analytics_script' => 'Script de Analytics',
    'admin.config.analytics_script_help' => 'Cole aqui o código de rastreamento (ex: Google Analytics, Plausible, Matomo). O conteúdo será injetado no <code>&lt;head&gt;</code> de todas as páginas públicas.',
    'admin.config.placeholder' => '<!-- cole seu script de analytics aqui -->',
    'admin.config.save' => 'Salvar',
